...
using SwiftHR.LeaveManagement.Application.Features.LeaveRequest.Commands.CancelLeaveRequest;
using SwiftHR.LeaveManagement.Application.Features.LeaveRequest.Commands.ChangeLeaveRequestApproval;
using SwiftHR.LeaveManagement.Application.Features.LeaveRequest.Commands.CreateLeaveRequest;
using SwiftHR.LeaveManagement.Application.Features.LeaveRequest.Commands.DeleteLeaveRequest;
...
public class LeaveRequestsController : ControllerBase
{
    ...
    {
        var leaveRequests = await _mediator.Send(new GetLeaveRequestListQuery(isLoggedInUser));
